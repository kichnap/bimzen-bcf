...
namespace Bcf.Core.Clash
{
    ...
    public enum SnapshotIsolation
    {
        ...
        /// <summary>
        /// Бокс и скрытие вместе. Секущий бокс убирает всё за своими границами,
        /// но внутри бокса остальные элементы остаются видимыми — стены комнаты,
        /// в которой лежит коллизия, никуда не денутся. Этот режим убирает и их.
        /// </summary>
