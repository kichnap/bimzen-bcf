...
namespace Bcf.Core.Clash
{
    ...
    public class ClashElementInfo
    {
        ...
        /// <summary>
        /// Откуда взялся числовой идентификатор: свойство и на сколько
        /// уровней выше элемента оно нашлось.
        ///
        /// Нужно потребителю, который сверяет нашу выгрузку со своим разбором
        ...
        /// из них в файле, важнее, чем кажется: перепутав, потребитель
        /// опознает соседний элемент, и это не выглядит как ошибка.
        /// </summary>
